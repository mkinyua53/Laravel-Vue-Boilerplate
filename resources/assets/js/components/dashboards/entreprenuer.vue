  ...
  <transition name="">
    <div data-app="true" :class="['application', $store.getters.mode]" id="default">
      <v-toolbar app :color="$mode == 'theme--dark' ? '' : 'green'" class="lighten-1" dark :extended="$breakpoint.smOnly" clipped-left>
        ...
        <v-toolbar-items>
          <v-btn class="pa-0 mt-0" icon flat to="/shops" title="Shops">
            <v-icon>fa-shopping-bag</v-icon>
          </v-btn>
        </v-toolbar-items>
        <v-toolbar-items>
          <v-btn class="pa-0 mt-0" icon flat to="/entreprenuers" title="Entreprenuers">
    ...
    data () {
      return {
        items: [
          {
            name: 'DashBoard',
            path: '/entreprenuer-dashboard',
            icon: 'dashboard',
            title: 'DashBoard'
          },
          {
            title: 'Shops',
            path: '/entreprenuer-dashboard/shops',
            icon: 'fa-shopping-bag',
            name: 'Shops'
          },
          {
            title: 'Entreprenuers',
            path: '/entreprenuer-dashboard/entreprenuers',
            icon: 'fa-briefcase',
            name: 'Entreprenuers',
          }
        ]
