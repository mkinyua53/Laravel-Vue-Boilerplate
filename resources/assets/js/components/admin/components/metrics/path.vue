      ...
      <v-layout wrap>
        ...
        <v-flex xs12 class="px-2">
          ...
          <table class="table table-responsive">
            <thead>
              <tr>
                <th style="max-width: 150px !important;">Page</th>
                <th><span style="visibility: hidden;">Usage by Percentage</span></th>
              </tr>
            </thead>
            <tbody>
              <tr v-for="log in paginated('access')" :key="log.path" class="">
                <td style="max-width: 150px !important;"><a :href="log.path" target="_blank">{{ log.path }}</a></td>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      grouped () {
        return _.uniqBy(this.access_logs, 'path')
      },
      access () {
